    ...
    <div class="row">
        <div class="col-md-3">
            <div data-wow-delay="0.5s" class="animated fadeInUp delay-7s">
                <div style="border-right:solid #BDBDBD;height:auto;">
                    ...
                    <a href="institutionalmembers" class="btn membtn_active">Institutional Members</a>
        ...
        <div class="col-md-9">
            ...
            <div style="background-color: white;padding: 15px;">
                <h4 style="margin-bottom: 30px">Institutional Members</h4>


                @foreach($institutionalmembers as $institutionalmember)

                    @if($institutionalmember->requested_membership == "im")
                        <div style="text-align: justify;width: 95%;">
                            <div class="row">
                                <div class="col-md-2">
                                    <img style="width: 80px;height: 80px;border-radius: 80px;" src="{{asset('profile_photo/'.$institutionalmember->profile_photo)}}">
                                </div>
                                <div class="col-md-6">
