        ...
        <div class="row">
            ...
            <div class="col-md-8">
                ...
                <p>The Ananda Coomaraswamy Memorial Medal- Awarded by the Geological Society of Sri
                    ...
                    Ananda Coomaraswamy Memorial Oration during a special session organized by the GSSL.</p>

                <a href="ananda_coomaraswamy_medal_winners" class="btn btn-outline-success">Winners</a><br><br>
                <hr>
                <br>
                @if(count($anandas)>0)
