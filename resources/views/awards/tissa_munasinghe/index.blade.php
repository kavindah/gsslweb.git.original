...
<div style="background-color: #ffffff">
	<div class="row">
		...
		<div style="border-right:solid #BDBDBD;height:auto;">
				...
				<a href="/tissa_munasinghe_scholarship" class="btn membtn_active">Tissa Munasinghe Scholarship</a>
		...
		<div class="col-md-8">
			...
			<p>The “Dr. Tissa Munasinghe Scholarship” of the GSSL awards annually to an undergraduate student
				...
				Scholarship Fund.</p><br>
			<a href="tissa_munasinghe_sch_winners" class="btn btn-outline-success">Winners</a><br><hr>
			@if(count($tissas)>0)
			@foreach($tissas as $tissa)
				...
				<hr style="width:90% ">
						...
						@if(!Auth::guest())
							@if(Auth::user()->id==$tissa->user_id)
					<div class="row">
						<div class="col-md-3">
							
					<a href="/tissa_munasinghe_scholarship/{{$tissa->id}}/edit" class="btn membtn">Edit</a>
					</div>
					<div class="col-md-3">
					{!!Form::open(['action'=>['tissamunasinghecontroller@destroy',$tissa->id],'method'=>'POST', 'class'=>'pull-right','onsubmit' => 'return ConfirmDelete()'])!!}
