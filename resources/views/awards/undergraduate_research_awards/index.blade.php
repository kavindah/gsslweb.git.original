                        ...
                        @if(!Auth::guest())
                            @if(Auth::user()->id==$undergraduateresearchaward->user_id)
                                <div class="row">
                                    ...
                                    <div class="col-md-3">
                                        {!!Form::open(['action'=>['undergraduateresearchawardcontroller@destroy',$undergraduateresearchaward->id],'method'=>'POST', 'class'=>'pull-right','onsubmit' => 'return ConfirmDelete()'])!!}
