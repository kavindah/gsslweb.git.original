...
<a href="/home" class="btn membtn" style="width: 20%;"><span class="glyphicon glyphicon-chevron-left"></span> Go To Dashboard</a><br>
	<h3>Create GSSL Undergraduate Research Award - Winners</h3>
	
	{!! Form::open(['action'=>'undergraduateresearchawardwinnerscontroller@store','method'=>'POST','enctype'=>'multipart/form-data' ]) !!}
