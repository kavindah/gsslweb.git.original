                        ...
                        @if(!Auth::guest())
                            @if(Auth::user()->id==$undergraduateresearchawardswinner->user_id)
                                <div class="row">
                                    ...
                                    <div class="col-md-3">
                                        {!!Form::open(['action'=>['undergraduateresearchawardwinnerscontroller@destroy',$undergraduateresearchawardswinner->id],'method'=>'POST', 'class'=>'pull-right','onsubmit' => 'return ConfirmDelete()'])!!}
