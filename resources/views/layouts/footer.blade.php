<div class="footer">
    ...
    <div class="row">
        <div class="col-md-2">
           <div style="font-size:18px">&nbsp; Publications</div> <br>
        ...
        <div class="col-md-2">
            <div style="font-size:18px">&nbsp; Activities</div><br>
        ...
        <div class="col-md-2">
            <div style="font-size:18px">&nbsp; JGSSL</div><br>
        ...
        <div class="col-md-2">
            <div style="font-size:18px">&nbsp; SLESO</div><br>
        ...
        <div class="col-md-2">
            <div style="font-size:18px">&nbsp; Awards</div><br>
    ...
    <div class="row">
        <div class="col-md-12">
            <center>
                ...
                <div style="display: none;"><a href="https://www.freecounterstat.com" title="website hit counter"><img
                                src="https://counter5.wheredoyoucomefrom.ovh/private/freecounterstat.php?c=fb93a7wruglgwflu4p12t6683xrymraj"
            ...
            <div class="row">
                <div class="col-md-12">
                    <label style="padding: 20px;text-align: center;font-size: 10px;">Copyright © 2018. This Site is
                        ...
                        updated and improved. If you have any comments and suggestions, please email the Co- Editors of
                        the GSSL Dr. Lalindra Ranaweera (laliwr@yahoo.com) or Dr. Nadeesha Koralegedara
