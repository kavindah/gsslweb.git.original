...
<a href="/home" class="btn membtn" style="width: 20%;"><span class="glyphicon glyphicon-chevron-left"></span> Go To Dashboard</a><br>
	<h2>Add new International Earth Science Olympiad Competition - Syllabus</h2>
	
	{!! Form::open(['action'=>'iesocomsyllabuscontroller@store','method'=>'POST','enctype'=>'multipart/form-data' ]) !!}
